...
try{
    ...
    try{
		if (document.form.product.value==""||document.form.product.value==0){
			alert('请选择生肖及守护神');
   ...
   try{
		if (document.form.province.value==""||document.form.province.value=="省份"){
			alert('请选择所在地区！');
    ...
    try{
		if (document.form.city.value==""||document.form.city.value=="城市"){
			alert('请选择所在城市！');
    ...
    try{
		if (document.form.area.value==""||document.form.area.value=="地区"){
			alert('请选择所在区！');
...
/*///////////////////////////////////////// ORDERJSFGX /////////////////////////////////////////*/
function pricea(){
	var product = document.form.product.title;//这里暂时只能找到select标签的title，暂时不能找到option的title
